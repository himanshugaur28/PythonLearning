...
# The format() method allows you to format selected parts of 
# a string.
...
# You can use index numbers (a number inside the curly 
...
# Also, if you want to refer to the same value more than once, 
...
# You can also use named indexes by entering a name inside 
# the curly brackets {carname}, but then you must use names 
